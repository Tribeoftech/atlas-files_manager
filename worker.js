/**
 * Processes image thumbnail creation jobs from the fileQueue.
 * Retrieves the file document from the database and generates
 * thumbnails at specified widths.
 */

/**
 * Processes welcome jobs from the userQueue.
 * Retrieves the user document from the database and logs
 * a welcome message.
 */
