/**
 * Tests pagination of GET /files API endpoint. Sets up test data, makes a request
 * to get the 2nd page of results for the root folder, and asserts the response
