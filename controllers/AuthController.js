/**
 * AuthController handles authentication related functionality.
 *
 * Exports an object with methods:
 *
 * - getConnect: Authenticates user credentials and returns a token.
 *
 * - getDisconnect: Invalidates the user's token.
 */
...
/**
 * Exports the AuthController object which contains auth related handler functions.
 */
